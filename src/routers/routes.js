...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: '/dota-data/dota-all-rank',
        component: () => import('@/pages/dotaAllRank/index.vue')
      },
      {
      ...
      {
        path: '/dota-data/dota-search/:search',
        component: () => import('@/pages/dotaSearch/index.vue')
      },
      {
        path: '/dota-data/dota-hero-rate',
        component: () => import('@/pages/dotaHeroRate/index.vue')
      }
    ]
  },
  {
