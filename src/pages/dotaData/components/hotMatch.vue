<template>
  <Card class="hot-match-box" title="Dota2赛事" :bordered="false" :dis-hover="true">
    <template #extra>
      <span class="href" @click="toAllEvent">更多<Icon type="ios-arrow-forward" /></span>
    </template>
    <page-loading :show="loading" />
    <div v-if="!loading">
      <div class="match">
        <div v-for="item in matchList" :key="item.id" class="match-item" @click="toEventDetail(item)">
          <Image width="100%" height="120px" :src="item.coverUrl" lazy>
